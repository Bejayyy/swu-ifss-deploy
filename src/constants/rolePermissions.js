...
export const PERMISSIONS = {
  ...
  COLLEGE_INVENTORY_MANAGE: 'college.inventory.manage',
...
export const ROUTE_PERMISSIONS = {
  ...
  '/college-inventory': PERMISSIONS.COLLEGE_INVENTORY_MANAGE,
...
export const NAV_ITEMS = {
  ...
  collegeInventory: { label: 'College Inventory', path: '/college-inventory', permission: PERMISSIONS.COLLEGE_INVENTORY_MANAGE },
  courseInventory: { label: 'Course Inventory', path: '/courses', permission: null },
