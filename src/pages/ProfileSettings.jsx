...
import { User, Lock, Bell, ChevronRight, KeyRound, Camera, Upload, Trash2, ShieldCheck, Laptop } from 'lucide-react';
              ...
              <div className="p-5 border border-slate-200/90 bg-white rounded-2xl space-y-3">
                ...
                <div className="p-3.5 bg-slate-50 border border-slate-200/80 rounded-xl flex items-center justify-between text-xs">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-bold text-gray-900">Current Web Session</p>
                      <p className="text-[11px] text-gray-500">Authenticated via SWU IFSS System</p>
                    </div>
                  </div>
