                  ...
                  return (
                    <SidebarMenuItem key={path}>
                      <SidebarMenuButton
                        ...
                        className={`group w-full justify-start gap-2.5 px-3 py-2 text-[13.5px] font-medium rounded-lg transition-all ${
                          active
                  ...
                  return (
                    <SidebarMenuItem key={building.id}>
                      <SidebarMenuButton
                        ...
                        className={`w-full justify-start gap-2 px-2 py-1.5 rounded-lg text-[12px] font-semibold transition-colors ${
                          buildingActive
                            ? 'bg-red-50/60 text-[#7A0808] font-bold'
                      ...
                      {isExpanded && (
                        <SidebarMenuSub className="mx-2 my-0.5 border-l border-gray-200 pl-2">
                          {building.floorData.map((floorObj) => {
                            const floorKey = `${building.id}-${floorObj.floor}`;
                            const isFloorExpanded = expandedFloors[floorKey];

                            return (
                              <SidebarMenuSubItem key={floorKey} className="py-0.5">
                                <div
                                  className="flex items-center gap-1.5 py-1 px-2 rounded-lg cursor-pointer hover:bg-gray-100 group transition-colors"
                                  ...
                                  <div className="pl-3 mt-0.5 space-y-0.5">
                                    {floorObj.rooms.map((room) => {
                                      ...
                                      return (
                                        <div
                                          key={room.id}
                                          className={`flex items-center gap-1.5 py-1 px-2 rounded-lg cursor-pointer group transition-colors ${
                                        ...
                                        >
                                          ...
                                          {isUnderMaintenance ? (
                                            ...
                                            <span
                                              className="text-[9px] font-bold px-1.5 py-0.5 rounded-md"
                                              style={{ background: '#FFF0F0', color: MAROON }}
                                            >
                                              Lecture
                                            </span>
                                          ) : null}
